#The list contains vehicle registration numbers in Poland. Cars from Krakow have numbers starting with the letters 'KR' or 'KK'. Write a program that prints car registration numbers from Krakow. Number the list printed.
